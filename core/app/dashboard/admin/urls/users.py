...
urlpatterns = [
    ...
    path("users/<int:pk>/wishlist/detail/",views.AdminUsersDetailWishlistView.as_view(),name="users-wishlist"),
    path("users/<int:pk>/order/detail/",views.AdminUsersDetailOrderView.as_view(),name="users-order"),
    path("users/<int:pk>/review/detail/",views.AdminUsersDetailReviewView.as_view(),name="users-review"),
    path("users/<int:pk>/chat/detail/",views.AdminUsersDetailChatView.as_view(),name="users-chat"),
